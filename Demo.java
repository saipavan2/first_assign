...
class Demo extends JFrame implements ActionListener
{
	JFrame f1,f2,f3,f4,f5,f6,f7,f8,f9;
		JButton b1,b2,b3,b4,b5,b6,b7,b8,b9,b10,b11,b12,b13,b14,b15,b16,b17,b18,b19,b20,b21,b34,b50,b101,b102,b103,b104,b111,b118;
...
String s=String.valueOf(index);
		...
		ImageIcon background_image5=new ImageIcon("sadiq30.jpg");
		Image img5=background_image5.getImage();
		Image temp_img5=img5.getScaledInstance(1000,1000,Image.SCALE_SMOOTH);
		background_image5=new ImageIcon(temp_img5);
		JLabel background5=new JLabel("",background_image5,JLabel.CENTER);
				background5.setBounds(0,0,1000,1000);
	f6.add(background5);
					f6.setVisible(true);
		}
		...
		ImageIcon background_image6=new ImageIcon("sadiq60.jpg");
		Image img6=background_image6.getImage();
		Image temp_img6=img6.getScaledInstance(1000,1000,Image.SCALE_SMOOTH);
		background_image6=new ImageIcon(temp_img6);
		JLabel background6=new JLabel("",background_image6,JLabel.CENTER);
				background6.setBounds(0,0,1000,1000);
	f7.add(background6);
